...
import com.sinau.android.sinauYo.model.Post;
        ...
        mDatabase.child("users").child(userId).addListenerForSingleValueEvent(
                ...
                new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        // Get userModul6 value

                        User userModul6 = dataSnapshot.getValue(User.class);
                        ...
                        if (userModul6 == null) {
                            ...
                            // UserModul6 is null, error out

                            Log.e(TAG, "UserModul6 " + userId + " is unexpectedly null");

                            Toast.makeText(PostFoto.this,

                                    "Error: could not fetch userModul6.",
                            ...
                            writeNewPost(userId, userModul6.username, title, body);
